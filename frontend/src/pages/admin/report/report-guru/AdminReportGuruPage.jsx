...
import { useAdminReportGuruController } from "./adminReportGuru.controller";
import "../../../guru/Report.css";

export default function AdminReportGuruPage() {
  const { toggleSidebar } = useOutletContext();
  const c = useAdminReportGuruController();
  ...
  return (
    <div className="rpage">
      ...
      <div className="rhead">
        ...
        <div><h1>Report Guru</h1></div>
      </div>

      {/* pesan error */}
      {c.error && <div className="ralert">{c.error}</div>}

      {/* card (start, end, guru, sekolah + tombol terapkan filter) */}
      <div className="rcard">
        <div className="rfilters">
          ...
          {/* filter guru (admin wajib pilih guru dulu) */}
          <div className="rfield">
          ...
          {/* filter sekolah (aktif setelah guru dipilih) */}
          <div className="rfield">
            <label>Sekolah</label>
            <select 
